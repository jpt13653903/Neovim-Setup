...
syn match       cHungarian      "\<\(G_\|m_\|g_\)\=\([pamvch]\|lp\)*\(v\|b\|f\|c\|ch\|st\|cl\|s\|e\|t\|sz\|br\|fn\|w\|dw\|l\|ui\)\ze\u\i*\>"
syn match       cHungarian      "\<\(G_\|m_\|g_\)\=\([pamvch]\|lp\)*[ui][1248]\=\ze\u\i*\>"
syn match       cHungarian      "\<\(G_\|m_\|g_\)\=\([pamvch]\|lp\)*[fc]\(4\|8\|10\)\ze\u\i*\>"
syn match       cHungarian      "\<\(G_\|m_\|g_\)\=\(thr\|th\|h\|it\|lp\)\ze\u\i*\>"
syn match       cHungarian      "\<b\d\+\ze\u\i*\>"
syn match       cHungarian      "\<n\ze\u\i*\>"
syn match       cHungarian      "\<G_\ze\u\i*\>"

syn match       cParamDirection "\<_\(In\|Out\)_\(opt_\)\?\>"

" Windows API types
syn match       cType           "\<BYTE\>"
syn match       cType           "\<T\?CHAR\>"
syn match       cType           "\<U\?INT\>"
syn match       cType           "\<D\?WORD\>"

" RRS Types
syn match       cType           "\<[UI][1248]\>"
syn match       cType           "\<F\(4\|8\|10\)\>"
syn match       cType           "\<CH\>"
...
hi def link cHungarian          NonText
hi def link cParamDirection     NonText
